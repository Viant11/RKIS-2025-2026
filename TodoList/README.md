...
Если вы сталкиваетесь с некорректным отображением кириллицы при запуске по умолчанию, рекомендуется:
1.  Установить **Windows Terminal** из Microsoft Store.
2.  Выбрать профиль запуска **"Windows Terminal Debug"** в Visual Studio.
